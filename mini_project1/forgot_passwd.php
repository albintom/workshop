...
<link rel="stylesheet" type="text/css" href="css/work.css">
  ...
  <body>
   ...
   <center><h2><b>FORGOTT PASSWORD</b></h2></center>
  ...
  <br><br>
        <tr>
    &nbsp  <td><b>Email</b></td>&nbsp&nbsp
    <td><input type="email" placeholder="Enter email" name="uname" required></td></tr>
    <br><br>
    <tr>
      *we are send your new password to yor email plz check
  <center>
  <button class="button" type="submit" name="submit">submitt</button>
