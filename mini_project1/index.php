  ...
  <body>
                            ...
                            <div class="navbar">
                                ...
                                <div class="navbar-collapse collapse">
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li><a class="smoth-scroll" href="#portfolio">Gallery</a>
                                        </li>
                ...
                <div class="display-table-cell">
                    <div class="container">
                        <div class="row">
                          ...
                          <a class="button button-style button-style-icon fa fa-long-arrow-right smoth-scroll" href="#portfolio">View Gallery</a>
                                  </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="section-title">
                        <h2>Gallery.</h2>
                        <p>our vehicle services and other works images</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <ul class="portfolio">
                    ...
                    <li class="filter" data-filter=".apps">services</li>
                    <li class="filter" data-filter=".mockups">spare</li>
                    <li class="filter" data-filter=".wordpress">vehicles</li>
                </ul>
            </div>
       ...
       <div class="container">
               ...
               <div class="col-md-4 col-sm-4">
                <div class="contact-us-detail">
                 <i class="fa fa-mobile color-6"></i>
                  <p><a href="tel:+1234567890">9446407273</a></p>
                 </div>
                </div>
               ...
               <div class="col-md-4 col-sm-4">
                <div class="contact-us-detail">
                 <i class="fa fa-mail-reply color-5"></i>
                  <p><a href="mailto:name@domain.com">eworkshop@gmail.com</a></p>
                 </div>
                </div>
         ...
         <div class="row">
                ...
                <p class="contact-us-details">
	        				<b>Address:</b> E-WORKSHOP,Near AJCE,Kanjirappalli,kottayam,Kerala,india<br/>
	        				<b>Phone:</b>9446407273<br/>
	        				<b>Fax:</b> +44 123 654321<br/>
	        				<b>Email:</b> <a href="mailto:getintoutch@yourcompanydomain.com">eworkshop@gmail.com</a>
	        			</p>
            ...
            <div class="col-md-6">
             ...
             <iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d15738.943154104414!2d76.8201864!3d9.531668600000001!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1501837664896" width="600" height="450" frameborder="0" style="border:0" allowfullscreen"></iframe>
							<br />
							<small>
								<a href="https://www.google.co.in/maps/place/Kottayam,+Kerala/@9.5947087,76.485573,13z/data=!3m1!4b1!4m5!3m4!1s0x3b062ba16c6b435f:0xbe2b02f68f8dd06e!8m2!3d9.5915668!4d76.5221531"></a>
							</small>
							</iframe>
            </div>
           </div>
    ...
    <footer class="footer-section">
      ...
      <div class="col-md-4 text-left">
       <p><span><a href="#about" class="smoth-scroll">About Me</a></span> | <span><a href="#portfolio" class="smoth-scroll">E-WORKSHOP</a></span></p>
          </div>

            <div class="col-md-4 text-center">
               <p>© Copyright 2017 E-WORKSHOP.</p>
               </div>

             <div class="col-md-4 uipasta-credit text-right">
                <p>Design By <a href="http://www.uipasta.com" target="_blank" title="UiPasta">albin</a></p>
                </div>
